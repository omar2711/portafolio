...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Contributed to the frontend development of BlokisLabs, a web platform for a startup with my friends. Worked as part of the development team to create the user interface.",
